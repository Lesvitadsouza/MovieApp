...
The first page consists of a search area to search the movie by name which on clicking on the image redirects to the second page which conatins basic  information on the searched movie.
